...
LABEL org.opencontainers.image.title="krankenhaus" \
    org.opencontainers.image.description="Appserver krankenhaus mit Basis-Image Trixie hardened" \
...
ENTRYPOINT ["python", "-m", "krankenhaus"]
